...
This module contains the complete proof development for the statements in
`Challenge.lean`, whose compared declarations it mirrors with identical
statements and completed proofs. The development formalizes the core results
of *Chain bounding, the leanest proof of Zorn's lemma, and an illustration of
computerized proof formalization* (Guillermo L. Incatasciato and Pedro
Sánchez Terraf, published in the *American Mathematical Monthly*; preprint
freely accessible at <http://arxiv.org/abs/2404.11638>).
-/
